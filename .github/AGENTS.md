...
- Staging promotion is manually dispatched from `main`, targets the protected `Staging` environment, and promotes backend migrations/functions before uploading the already archived `tunedIn Beta` build. Never trigger it automatically on merge.
